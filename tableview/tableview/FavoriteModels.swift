...
struct FavoritesData {
    static let movies: [FavoriteItem] = [
        ...
        .init(
            ...
            review: "A young blade runner uncovers a long-hidden secret that could plunge what's left of society into chaos.",
        ...
        .init(
            ...
            review: "A linguist works with the military to communicate with alien lifeforms after twelve mysterious spacecraft appear around the world.",
            imageName: "arrival",
            sfSymbol: nil
        ),
        .init(
            ...
            review: "A thief who steals corporate secrets through dream-sharing technology is given the inverse task of planting an idea into a CEO's mind.",
            imageName: "inception",
            sfSymbol: nil
        ),
        .init(
    ...
    static let books: [FavoriteItem] = [
        .init(
            ...
            review: "Teaches how to write readable, maintainable, and clean software without turning your project into chaos.",
            imageName: "clean_code",
            sfSymbol: nil
        ),
        .init(
            title: "The Pragmatic Programmer",
            subtitle: "Andrew Hunt & David Thomas · 1999",
            review: "A foundational book on thinking like a mature developer, improving workflow, and building resilient systems.",
            imageName: "pragmatic_programmer",
            sfSymbol: nil
        ),
        .init(
            title: "Design Patterns: Elements of Reusable Object-Oriented Software",
            subtitle: "Gamma, Helm, Johnson, Vlissides · 1994",
    ...
    static let courses: [FavoriteItem] = [
        .init(
            ...
            subtitle: "Instructor: Arman Myrzakanuarov",
        ...
        .init(
            ...
            subtitle: "Instructor: Pakita Shamoi",
            review: "Explores encapsulation, inheritance, polymorphism, and OOP design principles with practical coding exercises.",
            imageName: "oop",
            sfSymbol: nil
        ),
        .init(
            title: "Software Engineering",
            subtitle: "Instructor: Aldamuratov Zhomart",
            review: "Focuses on development lifecycle, design principles, teamwork, testing strategies, and large-scale project thinking.",
            imageName: "software_engineering",
            sfSymbol: nil
        ),
        .init(
            title: "Introduction to Business Management",
            subtitle: "Instructor: Askar Aituov",
            review: "Provides understanding of organizational structure, decision-making, strategy, and the fundamentals of modern management.",
            imageName: "ibm",
            sfSymbol: nil
        ),
        .init(
            title: "Computer Architecture",
            subtitle: "Instructor: Sukhrab Yoldash",
            review: "Explains CPUs, memory hierarchy, instruction cycles, and how hardware design impacts software performance.",
            imageName: "comp_arch",
            sfSymbol: nil
        )
    ]
